...
void custom_CFRunLoopRun(void) {
    longjmp(server_start_env, 1);
}
...
__attribute__((used)) static struct {
    ...
    //{ (const void *)custom_CFRunLoopRun, (const void *)CFRunLoopRun },
    //{ (const void *)custom_exit, (const void *)exit }
};
